...
from utils import validate_model, allowed_file, handle_file_upload, format_json_response

app_routes = Blueprint('app_routes', __name__, url_prefix='/api/v1/stores')

CARD_UPLOAD_FOLDER = 'app/static/images/card_images/'
...
def create_store():
    ...
    image_filename = handle_file_upload(request, CARD_UPLOAD_FOLDER, ALLOWED_EXTENSIONS)
